...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ID_leds [ create_bd_port -dir O -from 2 -to 0 ID_leds ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS { \
     ...
     0#Enet 0 \
     0#Enet 0 \
     0#SD 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#Enet \
     0#SD 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#Enet \
     0#SD 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#Enet \
     0#UART 0#Enet \
     0#USB 0#SD \
     ...
     0#USB 0#SD \
     0#USB 0#SD \
     GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#USB Reset#GPIO#GPIO#GPIO#GPIO#UART \
   } \
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins xadc_wiz_0/convst_in]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
  connect_bd_net -net xadc_wiz_0_busy_out [get_bd_ports busy_led] [get_bd_pins xadc_wiz_0/busy_out]
  connect_bd_net -net xadc_wiz_0_channel_out [get_bd_pins xadc_wiz_0/channel_out] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net xadc_wiz_0_ip2intc_irpt [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xadc_wiz_0/ip2intc_irpt]
  connect_bd_net -net xlslice_0_Dout [get_bd_ports ID_leds] [get_bd_pins xlslice_0/Dout]
