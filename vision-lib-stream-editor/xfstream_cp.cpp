...
#define DATA_WIDTH 24		// rgb 8bits x 3 = 24 bits
#define NPIX XF_NPPC1		// number of pix of per cycle

/*  set the height and width  */
#define WIDTH 3840
#define HEIGHT 2160
#define FILTER_SIZE 3
#define TYPE XF_8UC3		// colcor 3 channel, each channel 8 bit
...
void stream_cp_accel(stream_t& src, stream_t& dst,
    ...
    xfMat2axis<DATA_WIDTH, TYPE, HEIGHT, WIDTH, NPIX>(src_mat, dst);
